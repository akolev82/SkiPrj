...
<div class="row featurette" id="slide1" data-slide="1" data-stellar-background-ratio="0.5">
    ...
    <div class="col-md-5">
        <img class="featurette-image img-responsive-right" src="<?php echo $this->webroot; ?>/img/middle1.jpg" alt="Generic placeholder image">
    </div>
</div>
<hr class="featurette-divider">
...
<div class="row featurette" id="slide3" data-slide="3" data-stellar-background-ratio="0.5">
    ...
    <div class="col-md-5">
        <img class="featurette-image img-responsive-right" src="<?php echo $this->webroot; ?>/img/middle3.jpg" alt="Generic placeholder image">
    </div>
</div>
<hr class="featurette-divider">
<!-- /END THE FEATURETTES -->