...
<?php echo $this->Form->create('School'); ?>
	...
	<?php
		echo $this->Form->hidden('SchoolID');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('School.SchoolID')), null, __('Are you sure you want to delete # %s?', $this->Form->value('School.SchoolID'))); ?></li>
