...
echo '<div class="actions">';
  ...
  echo '<ul class="nav-bar">';
    echo '<li class="nav-button-edit">' . $this->Html->link(__('Edit User'), array('action' => 'edit', $UserID)) . '</li>';
    echo '<li class="nav-button-add">' . $this->Html->link(__('Add Role'), array('action' => 'add_role', $UserID)) . '</li>';
	echo '<li class="nav-button-delete">' . $this->Form->postLink(__('Delete User'), array('action' => 'delete', $UserID), null, __('Are you sure you want to delete # %s?', $UserID)) . '</li>';
	echo '<li class="nav-button-list">' . $this->Html->link(__('List Users'), array('action' => 'index')) . '</li>';
	echo '<li class="nav-button-add">' . $this->Html->link(__('New User'), array('action' => 'add')) . '</li>';
  echo '</ul>';
  echo '</nav>';
echo '</div>'; ?>
