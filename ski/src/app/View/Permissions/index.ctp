<div class="permissions index">
	...
	<tr>
		...
		<td><?php echo h($permission['Permission']['_create']); ?>&nbsp;</td>
		<td><?php echo h($permission['Permission']['_read']); ?>&nbsp;</td>
		<td><?php echo h($permission['Permission']['_update']); ?>&nbsp;</td>
		<td><?php echo h($permission['Permission']['_delete']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $permission['Permission']['id']), null, __('Are you sure you want to delete # %s?', $permission['Permission']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
